...
def get_args():
    ...
    parser.add_argument("--name", default="sketch2_add-fusion-twofocal-1-35-fusion-itcloss_05kl-text-label", help="experiment name to save")
    # parser.add_argument("--log_dir", default="logs")
    parser.add_argument("--output_dir", default="/data1/Code/fengyy/sketch/multimodality-CUHK")
    # parser.add_argument("--gpu_id", default="1", help="select gpu to run")
    ...
    parser.add_argument("--pretrain_choice", default='/data1/Code/fengyy/UNIReID-main/ViT-B-16.pt') # whether use pretrained model
    ...
    parser.add_argument("--root_dir", type=str, default="/data1/Code/fengyy/sketch/CUHK/")
    ...
    parser.add_argument("--focal_three_fusion_loss3", default=True, action='store_true', help="sketch label kl")
    ...
    parser.add_argument("--ga", type=float, default=3.5, help="parameter add for fusion")
    parser.add_argument("--klp", type=float, default=0.5, help="parameter add for fusion")

    parser.add_argument("--advance", default=True, action='store_true', help=" the advance model")
    parser.add_argument("--add_token_num", type=int, default=5)
